...
namespace src.Controllers.Api
{
    ...
    public class OrganizationController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> PostOrganization2([FromBody] Organization organization)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteOrganization2([FromRoute] Guid id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
