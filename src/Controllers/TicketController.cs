...
using src.Data;
using src.Models;
using Contact = src.Models.Contact;
...
//
//                IList<Contact> contacts = _context.Contact.Where(x => x.customer.organizationId.Equals(org)).ToList();
...
//                ViewBag.supportEngineersId = new SelectList(engineers, "SupportEngineerId",
//                    "SupportEnginnerName", ticket.supportEngineerId);
//                 
//                IList<Contact> contacts = _context.Contact.Where(x => x.customer.organizationId.Equals(ticket.organizationId)).ToList();
...
//        }
        ...
        public IActionResult AddEdit(Guid org, Guid id)
        {
            ...
            else
            {
                ...
                IList<SupportAgent> agents = _context.SupportAgent.Where(x => x.organizationId.Equals(ticket.organizationId)).ToList();
                ViewBag.supportAgentId = new SelectList(agents, "supportAgentId", "supportAgentName", ticket.organizationId);

                IList<SupportEngineer> engineers = _context.SupportEngineer.Where(x => x.organizationId.Equals(ticket.organizationId)).ToList();
                ViewBag.supportEngineersId = new SelectList(engineers, "supportEngineerId", "supportEngineerName", ticket.supportAgentId);
